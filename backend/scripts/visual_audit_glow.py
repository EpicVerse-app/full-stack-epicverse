...
async def main():
    # DB Mapping for GlowLine: GlowLine (KishkindhaKanda)
    mode = "GlowLine (KishkindhaKanda)"
    
    # Test 1: Valid (Rama + Hear)
    await audit_combo(mode, "1", "81")
    
    # Test 2: Valid (Rama + Support)
    await audit_combo(mode, "1", "83")
    
    # Test 3: Valid (Rama + Anger)
    await audit_combo(mode, "1", "87")
